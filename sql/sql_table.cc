    ...
    */
        ...
        sql_field->sql_type == MYSQL_TYPE_ENUM)
    {
      /*
        ...
        Pass "true" as the last value. This makes create_typelib()
        reuse "interval_list" values in "interval" in cases when no
        character conversion is needed, to avoid extra copying.
      */
                             ...
                             Column_definition *sql_field)
{
      ...
      sql_field->sql_type == MYSQL_TYPE_ENUM)
  {
    /*
      ...
      This forces create_typelib() to allocate TYPELIB values on mem_root,
